...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (modeloMarker mm : cargarMarker()) {
            mapa.addMarker(new MarkerOptions().
                    ...
                    snippet("Decano: "+mm.getDecano()+"; Ubicación: "+"Lat: "+mm.getLat()+" , Lng: "+mm.getLng()+" ; "+mm.getLogo()));
    ...
    public List<modeloMarker> cargarMarker() {
        ...
        modeloMarker fci = new modeloMarker(
                ...
                "Ing. Chiriboga Casanova Washington Alberto",
        ...
        modeloMarker fce = new modeloMarker(
                ...
                "Ing. xxxx xxxxxxxxxx xxxxxxxxxxxx xxxxxxo",
        ...
        modeloMarker fcag = new modeloMarker(
                "Facultad Ciencias Agrarias",
                "Ing. xxxxxxx xxxxxxxxxx xxxxxxxxxxx xxxxxxxxx",
                "https://www.uteq.edu.ec/images/about/logo_fci.jpg",
                "-1.0128886603807776", "-79.46952746861176");
